...
debug_asan:
	clang -O0 -fprofile-instr-generate -fcoverage-mapping -fsanitize=address -g -Wall -Wextra -Wno-unused-parameter -I/usr/include/SDL2 -o bin zel.c -lm -lSDL2 -lSDL2_ttf
